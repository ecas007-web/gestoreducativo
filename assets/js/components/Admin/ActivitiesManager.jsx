        ...
        <div className="space-y-6">
            ...
            <div className="card p-0 overflow-hidden">
                <div className="flex flex-wrap gap-4 p-4 bg-slate-50 border-b items-end">
                    <div className="form-group mb-0 min-w-[180px]">
                        ...
                        <select className="form-input !py-2 text-sm" value={filterCurso} onChange={e => setFilterCurso(e.target.value)}>
                    ...
                    <div className="form-group mb-0 min-w-[180px]">
                        ...
                        <select className="form-input !py-2 text-sm" value={filterMateria} onChange={e => setFilterMateria(e.target.value)}>
                    ...
                    <div className="form-group mb-0 min-w-[180px]">
                        ...
                        <select className="form-input !py-2 text-sm" value={filterPeriodo} onChange={e => setFilterPeriodo(e.target.value)}>
            ...
            {modal.open && (
                <div className="modal-backdrop">
                    <div className="modal animate-fadeInUp !max-w-2xl">
