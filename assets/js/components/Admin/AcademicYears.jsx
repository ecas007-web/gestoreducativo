...
export const AcademicYearsManager = () => {
    ...
    const [formData, setFormData] = useState({ id: null, anio: '', fecha_inicio: '', fecha_fin: '', estado: false });
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            // Asegurarse de que anio sea un integer
    ...
    return (
        <div className="space-y-6">
            <div className="flex items-center justify-between">
                ...
                <button onClick={() => { setFormData({ id: null, anio: new Date().getFullYear(), fecha_inicio: '', fecha_fin: '', estado: false }); setShowModal(true); }} className="btn btn-primary">
            ...
            <div className="card p-0 overflow-hidden">
                <div className="table-wrapper">
                    <table className="data-table">
                        ...
                        <tbody>
                            {years.length === 0 ? (
                                <tr><td colSpan="4" className="text-center py-8 text-slate-500">No hay años académicos registrados.</td></tr>
                            ) : years.map(y => (
